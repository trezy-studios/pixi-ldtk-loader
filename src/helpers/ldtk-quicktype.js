 ...
 * @property {number} defaultEntityHeight 
 * Default height for new entities
 * @property {number} defaultEntityWidth 
 ...
 * @property {null|string} [editorDisplayColor]
 ...
 * User defined unique identifier
 * @property {TilesetRectangle|null} [tile]
 ...
 * @property {number} __worldX 
 * X world coordinate in pixels
 * @property {number} __worldY 
