// To parse this data:
//
//   import { Convert, LDTKProject } from "./file";
//
//   const lDTKProject = Convert.toLDTKProject(json);
//
...
export class Convert {
    public static toLDTKProject(json: string): LDTKProject {
        return cast(JSON.parse(json), r("LDTKProject"));
    }

    public static lDTKProjectToJson(value: LDTKProject): string {
